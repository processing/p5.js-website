...
<SketchEmbed
  code={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/translate/sketch.js",
  )}
  cssCode={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/style.css",
  )}
  bodyCode={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/translate/index.html",
  )}
/>
...
<SketchEmbed
  code={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/rotate/sketch.js",
  )}
  cssCode={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/style.css",
  )}
  bodyCode={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/rotate/index.html",
  )}
/>
...
<SketchEmbed
  code={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/scale/sketch.js",
  )}
  cssCode={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/style.css",
  )}
  bodyCode={await fs.readFile(
    "src/content/tutorials/sketches/coordinates-and-transformation/scale/index.html",
  )}
/>
