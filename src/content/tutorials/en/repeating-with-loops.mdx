...
- The [p5.js Web Editor](https://editor.p5js.org?version={p5Version})
...
- Open a new project in the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}), give it a name like “Caterpillar Race”, and save it.
