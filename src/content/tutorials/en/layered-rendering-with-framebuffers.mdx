...
lights();
  noStroke();
  rotateX(millis() _ 0.001);
  rotateY(millis() _ 0.001);
...
<Callout>
  Can you simulate the vision of a fly by drawing a `p5.Framebuffer` many times
...
<Callout>
  Lots of music player software uses feedback to create audio visualizations.
  Try using feedback in a sketch that [reacts to
  music!](https://p5js.org/reference/#/p5.Amplitude)
</Callout>
...
_Depth-based blur shaders are more advanced and are beyond the scope of this tutorial. If you are interested in how they work, you can look at_ [_an example of Framebuffer depth blur_](https://p5js.org/examples/3d-blur-using-framebuffer-depth.html)_._
...
../../../components/SketchEmbed../../../components/Callout../../../components/Columns
