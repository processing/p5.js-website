...
For example, you can modify the if statement in your sunrise animation by removing the [`background()`](/reference/p5/background) function and adding the following if-else statement: 
