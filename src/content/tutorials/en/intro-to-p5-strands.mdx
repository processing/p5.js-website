...
When you write a p5.js sketch, you are giving the CPU instructions in a sequence. When you add a shader - using p5.strands or GLSL - you are giving instructions to the GPU to run many times at once, simultanously. For example, in a fragment shader, that means many simultaneous calculations for each pixel.
