...
![A labeled diagram showing a triangle with three corners at coordinates (x1, y1), (x2, y2), and (x3, y3). The syntax for the triangle function is displayed above: "triangle(x1, y1, x2, y2, x3, y3);"](../images/introduction/triangle-diagram.png)
