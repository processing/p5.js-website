...
- An account on the  [p5.js Web Editor](https://editor.p5js.org?version={p5Version})
...
- Open the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) in a browser, name your project “Animating with Media Objects”, and save it to your account.
...
- Mark the [`setup()`](/reference/p5/setup) function with the [`async`](/reference/p5/async_await) keyword
  - This loads the image information into memory using [`await`](/reference/p5/async_await) [`loadImage()`](/reference/p5/loadImage).
