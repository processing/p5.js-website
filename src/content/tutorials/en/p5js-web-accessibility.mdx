---
slug: p5js-web-accessibility
title: "p5.js Web Accessibility"
description: Understand and use p5.js’ Web Accessibility features to make your sketch accessible
category: accessibility
featuredImage: ../images/featured/p5js-web-accessibility.png
featuredImageAlt: The p5.js Web Editor interface, showing screen reader accessible buttons.
relatedReferences:
  - p5/textOutput
  - p5/gridOutput
  - p5/describe
...
The following strategies involve making p5.js sketches screen reader accessible. A [screen reader](https://en.wikipedia.org/wiki/Screen_reader) is an assistive technology. It renders on-screen text and images as speech or braille. This technology supports those with vision impairment, cognitive disabilities, or other limitations.

For a tutorial on making your sketches screen reader accessible, visit [Writing Accessible Canvas Descriptions](/tutorials/writing-accessible-canvas-descriptions).

p5.js’ web accessibility features are also helpful for screen reader users to author sketches with. For a tutorial on using the p5.js Web Editor with a screen reader, visit [How to Use the p5.js Web Editor with a Screen Reader](/tutorials/p5js-with-screen-reader).


## Prerequisites

- p5.js foundation
- [Contributor Guidelines](/contributor-docs/contributor-guidelines) with local development setup
- [Looking Inside p5.js](/tutorials/looking-inside-p5js)
- [Writing Accessible Canvas Descriptions](/tutorials/writing-accessible-canvas-descriptions)


## Labeling Your Canvas for Screen Readers

The canvas HTML element is a grid of pixels. It doesn’t provide any screen reader-accessible information about the shapes drawn on it. p5.js has several functions that make the canvas more accessible to screen readers by providing [fallback text](https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API/Tutorial/Basic_usage#accessible_content) descriptions. This document will describe some of the details of implementing these functions.
...
First, we’ll explore the library-generated outputs, `textOutput()` and `gridOutput().` The following code snippet will serve as an example.
...
`textOutput()` creates a screen reader-accessible output that describes the shapes present on the canvas. The general description of the canvas includes the canvas size, canvas color, and the number of elements in the canvas:

<AccessibleOutput>
<p>Your output is a, 400 by 400 pixels, lavender canvas containing the following 2 shapes:</p>
</AccessibleOutput>

This description is followed by a list of shapes where the color, position, and area of each shape are described: 

<AccessibleOutput>
<ul id="defaultCanvas0textOutput_list"><li><a href="#defaultCanvas0textOutputshape0">orange circle</a>, at top left, covering 1% of the canvas.</li><li><a href="#defaultCanvas0textOutputshape1">fuchsia square</a>, at bottom right, covering 2% of the canvas.</li></ul>
</AccessibleOutput>
...
<AccessibleOutput>
<table id="defaultCanvas0textOutput_shapeDetails" summary="text output shape details"><tbody><tr id="defaultCanvas0textOutputshape0"><th>orange circle</th><td>location = top left</td><td> area = 1%</td></tr><tr id="defaultCanvas0textOutputshape1"><th>fuchsia square</th><td>location = bottom right</td><td> area = 2%</td></tr></tbody></table>
</AccessibleOutput>
...
<AccessibleOutput>
<p id="defaultCanvas0gridOutput_summary" aria-label="grid output summary">lavender canvas, 400 by 400 pixels, contains 2 shapes:  1 circle 1 square</p>
</AccessibleOutput>
...
<AccessibleOutput>
<table id="defaultCanvas0gridOutput_map" summary="grid output content"><tbody><tr></tr><tr></tr><tr><td><a href="#defaultCanvas0gridOutputshape0">orange circle</a></td></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr><td><a href="#defaultCanvas0gridOutputshape1">fuchsia square</a></td></tr><tr></tr></tbody></table>
</AccessibleOutput>
...
<AccessibleOutput>
<ul id="defaultCanvas0gridOutput_shapeDetails" aria-label="grid output shape details"><li id="defaultCanvas0gridOutputshape0">orange circle, location = top left, area = 1 %</li><li id="defaultCanvas0gridOutputshape1">fuchsia square, location = bottom right, area = 2 %</li></ul>
</AccessibleOutput>

<details>
<summary>The generated HTML is as follows:</summary>
...
![A p5.js canvas, with the text descriptions described earlier present below it](../images/accessibility/accessible-output.png)
...
With example code, the page will output a description:
