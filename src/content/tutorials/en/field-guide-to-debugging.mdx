...
In this code, the programmer expected a rectangle to appear on the canvas; instead, the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) displayed an error message in the console, and nothing appeared (not even a blank canvas).
...
The [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) highlighted line 9 in red, indicating where you can find the error. The message in the console also specifies that the error is on line 9 of the `sketch.js` file (click the arrow next to `SyntaxError`).
...
The [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) highlighted line 11 in red, indicating where you can find the error. The message in the console also specifies that the error is on line 11 of the sketch.js file (click the arrow next to `SyntaxError`).
