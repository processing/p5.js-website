...
1. Set up your coding environment on the web using the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}), or on your computer using [Visual Studio Code (VS Code).](https://code.visualstudio.com/)
...
You can begin your coding journey with [p5.js](/reference/) using the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) or [VS Code](https://code.visualstudio.com/). 

The [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) is a website where programmers can write, test, share, or remix p5.js programs without needing to download or configure a *code editor* on a computer. A *code editor* makes writing and reading code easier by organizing and coloring text in a way that helps programmers see different parts of the code.
...
If you are new to p5.js, start with the [p5.js Web Editor](https://editor.p5js.org?version={p5Version})!


## Using the p5.js Web Editor<a id="web-editor"></a>

### Step 1: Open the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) sign-up page

- Open a desktop browser on your computer and go to [https://editor.p5js.org/](https://editor.p5js.org?version={p5Version}).
...
### Step 2: Create an account with [p5.js Web Editor](https://editor.p5js.org?version={p5Version})

- Once on the [sign-up page](https://editor.p5js.org/signup), create an account on the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) using one of the following options:
- Manual sign-up
  - Create a username.
...
- Authorize the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) to access your GitHub details by clicking the “Authorize processing” button.
...
### Step 3: Explore the [p5.js Web Editor](https://editor.p5js.org?version={p5Version})

The [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) is an online environment where programmers can write and test their p5.js code. Explore the different elements of the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) and their functions. 
...
If you are using a screen reader, you must turn on the accessible outputs in the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) and add the accessibility library in your html. To learn more, visit our guide to [using the p5.js Web Editor with a screen reader.](/tutorials/p5js-with-screen-reader/)
...
If you are using a screen reader, use the [p5.js Web Editor](https://editor.p5js.org?version={p5Version}) instead! To learn more, visit the “[How to Use the p5.js Web Editor with a Screen Reader](https://docs.google.com/document/u/0/d/1Q_leNn8lkeSUfAyq1jLQeLYq1h8pU9134QHNvMu4Tcw/edit)” resource.
