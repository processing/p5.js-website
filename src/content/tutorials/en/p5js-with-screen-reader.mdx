...
2. Read [How to Label Your p5.js Code](/tutorials/how-to-label-your-p5js-code) for a detailed introduction of [`textOutput()`](/reference/p5/textOutput) and [`gridOutput()`](/reference/p5/gridOutput). The p5.js Web Editor uses these functions to generate text descriptions of sketch canvases for a screen reader.
