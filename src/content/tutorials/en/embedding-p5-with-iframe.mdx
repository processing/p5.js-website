...
categoryIndex: 1
featuredImage: ../images/featured/embedding-p5-with-iframe.png
featuredImageAlt: A browser window containing a p5.js sketch embedded inside a nested iframe.
authors:
  - hxrshxz
  - Dave Pagurek
---
...
<Code lang="html" code={`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>My p5.js Sketch</title>
    <script src="https://cdn.jsdelivr.net/npm/p5@${p5Version}/lib/p5.js"></script>
    <style>
      body {
        margin: 0;
        padding: 0;
...
- Loading sketches directly into a container using Instance Mode (coming soon)
