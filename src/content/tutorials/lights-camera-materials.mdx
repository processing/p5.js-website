...
<SketchEmbed
  code={await fs.readFile(new URL('./sketches/lights-camera-materials/camera/sketch.js', import.meta.url))}
  cssCode={await fs.readFile(new URL('./sketches/lights-camera-materials/style.css', import.meta.url))}
  bodyCode={await fs.readFile(new URL('./sketches/lights-camera-materials/camera/index.html', import.meta.url))}
/>
...
<SketchEmbed
  width={400}
  code={await fs.readFile(new URL('./sketches/lights-camera-materials/fov/sketch.js', import.meta.url))}
/>
...
<SketchEmbed
  code={await fs.readFile(new URL('./sketches/lights-camera-materials/lights/sketch.js', import.meta.url))}
  cssCode={await fs.readFile(new URL('./sketches/lights-camera-materials/style.css', import.meta.url))}
  bodyCode={await fs.readFile(new URL('./sketches/lights-camera-materials/lights/index.html', import.meta.url))}
/>
...
<SketchEmbed
  code={await fs.readFile(new URL('./sketches/lights-camera-materials/material/sketch.js', import.meta.url))}
  cssCode={await fs.readFile(new URL('./sketches/lights-camera-materials/style.css', import.meta.url))}
  bodyCode={await fs.readFile(new URL('./sketches/lights-camera-materials/material/index.html', import.meta.url))}
/>
