...
<SketchEmbed
  code={await fs.readFile(new URL('./sketches/coordinates-and-transformation/translate/sketch.js', import.meta.url))}
  cssCode={await fs.readFile(new URL('./sketches/coordinates-and-transformation/style.css', import.meta.url))}
  bodyCode={await fs.readFile(new URL('./sketches/coordinates-and-transformation/translate/index.html', import.meta.url))}
/>
...
<SketchEmbed
  code={await fs.readFile(new URL('./sketches/coordinates-and-transformation/rotate/sketch.js', import.meta.url))}
  cssCode={await fs.readFile(new URL('./sketches/coordinates-and-transformation/style.css', import.meta.url))}
  bodyCode={await fs.readFile(new URL('./sketches/coordinates-and-transformation/rotate/index.html', import.meta.url))}
/>
...
<SketchEmbed
  code={await fs.readFile(new URL('./sketches/coordinates-and-transformation/scale/sketch.js', import.meta.url))}
  cssCode={await fs.readFile(new URL('./sketches/coordinates-and-transformation/style.css', import.meta.url))}
  bodyCode={await fs.readFile(new URL('./sketches/coordinates-and-transformation/scale/index.html', import.meta.url))}
/>
