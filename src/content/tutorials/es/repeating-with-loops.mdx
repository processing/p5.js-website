...
- Después podemos actualizar el valor en la posición `i`<sup>th</sup> del array `collasDeOrugas`, que es lo que la función `drawCaterpillar()` usa para mostrar la oruga.
