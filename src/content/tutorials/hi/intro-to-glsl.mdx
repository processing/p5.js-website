...
सभी वैरिएबल्स के लिए टाइप बताना ज़रूरी है।
...
फ़ंक्शन्स में पैरामीटर और रिटर्न वैल्यू का टाइप बताना ज़रूरी है।
...
इंट और फ़्लोट के बीच कन्वर्ज़न खुद करना पड़ता है।
...
GLSL में लूप को एक कॉन्स्टेंट वैल्यू पर रुकना चाहिए। अगर किसी शर्त के आधार पर लूप ख़त्म करना हो, तो `break` का उपयोग करके लूप से बाहर निकला जा सकता है।
...
किसी `vec4` के लिए, आप उसमें मौजूद डेटा को रंग या कोऑर्डिनेट की तरह एक्सेस कर सकते हैं। दोनों तरह से लिखना पूरी तरह बराबर है, इसलिए जो तरीका कोड को ज़्यादा पढ़ने में आसान बनाए, उसे चुनें।
...
अगर आपको ऐसा वेक्टर बनाना है जिसके सभी घटक एक जैसे हों, तो एक ही वैल्यू बार-बार लिखने की ज़रूरत नहीं है, इसे सिर्फ़ एक बार लिखें।
...
आप "स्वज़लिंग" (swizzling) नाम की तकनीक से किसी बड़े वेक्टर से छोटा वेक्टर निकाल सकते हैं: `.` के बाद नए वेक्टर में चाहिए क्रम में कई घटकों के नाम जोड़ें।
