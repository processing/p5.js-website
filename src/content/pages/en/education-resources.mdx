...
<ul class="list-none content-grid pb-4xl mb-lg border-b border-sidebar-type-color last:border-0  mt-[var(--spacing-xl)]">
 ...
 <EducationResource
    name="Ancient Brain"
    featuredImage={await import("../images/education-resources/ancient-brain.png")}
    featuredImageAlt="A screenshot of Ancient Brain's homepage”"
  >
    <Fragment slot="author">
       Mark Humphrys
    </Fragment>
    <Fragment slot="description">
      A coding site where users can write programs ("Worlds") that run in the browser, with detailed tutorials and support for p5.js.
    </Fragment>
    <Fragment slot="materials">
      [Website](https://ancientbrain.com/)
    </Fragment>
  </EducationResource>
