...
description: >
  ...
  <p>变量是用于存储值的容器。例如，一个变量可能包含类型为 <code>Number</code> 的 x 坐标，或者类型为 <code>String</code> 的名称。变量可以通过重新赋值来改变其值，如下所示：</p>
...
createCanvas(100, 100);
  ...
  <p>在所有花括号 <code>{}</code> 之外生命的变量是全局变量。全局变量可以在绘图的任何地方使用和更改：</p>
