...
description: >
  ...
  <p><code>createFilterShader()</code> 的工作方式与 <a href="/reference/p5/createShader">createShader()</a> 类似，但包含默认的顶点着色器。 <code>createFilterShader()</code> 旨在与 <a href="/reference/p5/filter">filter()</a> 一起使用来过滤画布的内容。 滤镜着色器将应用于整个画布，而不仅仅是 <a href="/reference/p5/p5.Geometry">p5.Geometry</a> 对象。</p>
  ...
  <p>创建的 <a href="/reference/p5/p5.Shader">p5.Shader</a> 还提供了<code>varyingvec2 vTexCoord</code>，这是一个值介于 0 和 1 <code>vTexCoord 之间的坐标，描绘像素在画布上绘制的位置。</p>
