...
<p>转换如 <a href="/reference/p5/translate">translate()</a>、<a href="/reference/p5/rotate">rotate()</a> 和 <a href="/reference/p5/scale">scale()</a> 在幕后使用矩阵-向量乘法。称为矩阵的数字表格编码了每个转换。然后矩阵中的值会与画布上的每个点相乘，这些点由向量表示。</p>
...
<p>有两种方式可以在二维和三维中调用 <code>applyMatrix()</code>。</p>
