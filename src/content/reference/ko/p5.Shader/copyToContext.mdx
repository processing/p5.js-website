...
description: >
  ...
  <p>매개 변수 <code>context</code>는 셰이더를 사용할 드로잉 컨텍스트입니다. 셰이더는 <code>myShader.copyToContext(pg)</code>에서와 같이 <a href="/reference/p5/p5.Graphics">p5.Graphics</a>의 인스턴스로 복사할 수 있습니다. 셰이더는 <code>myShader.copyToContext(window)</code>에서와 같이 <code>window</code> 변수를 사용하여 <a href="/reference/p5/p5.Graphics">p5.Graphics</a> 객체에서 메인 캔버스로 복사할 수도 있습니다.</p>
