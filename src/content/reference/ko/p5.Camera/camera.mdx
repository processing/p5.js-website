...
description: >
  ...
  <p>처음 세 개의 매개 변수 <code>x</code>, <code>y</code>, <code>z</code>는 "세상(world)" 공간에서 카메라의 위치 좌표입니다. 예를 들어, <code>myCamera.camera(0, 0, 0)</code>를 호출하면 카메라가 원점 <code>(0, 0, 0)</code>에 놓입니다. 기본적으로 카메라는 <code>(0, 0, 800)</code>에 놓입니다.</p>
