...
description: >
  <p>카메라의 방향을 변경하지 않고 "세상(world)" 공간에서 카메라의 위치를 설정합니다.</p>
  
  <p>매개변수인 <code>x</code>, <code>y</code>, <code>z</code>는 카메라가 위치해야 하는 좌표입니다.
  
  예를 들어, <code>myCamera.setPosition(10, 20, 30)</code>을 호출하면 카메라가 "세상" 공간에서 좌표 <code>(10, 20, 30)</code>에 배치됩니다.</p>
line: 3020
isConstructor: false
itemtype: method
example:
