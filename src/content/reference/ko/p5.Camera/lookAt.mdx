...
description: >
  ...
  <p>매개변수인 <code>x</code>, <code>y</code>, <code>z</code>는 카메라가 향해야 하는 "월드" 공간 상의 좌표입니다.
...
params:
  - name: x
    description: >
      <p>월드 공간에서 카메라가 향해야 하는 위치의 x 좌표.</p>
    type: Number
  - name: 'y'
    description: >
      <p>월드 공간에서 카메라가 향해야 하는 위치의 y 좌표.</p>
    type: Number
  - name: z
    description: >
      <p>월드 공간에서 카메라가 향해야 하는 위치의 z 좌표.</p>
    type: Number
chainable: false
---
