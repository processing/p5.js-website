...
description: >
  <p>WebGL 모드에서 스플라인 곡선을 그리는 데 사용되는 세그먼트 수를 설정합니다.</p>

  <p>WebGL 모드에서, 많은 평면 세그먼트를 사용하여 부드러운 모양을 그립니다.

  더 많은 평면 세그먼트를 추가하면 모양이 더 부드럽게 나타납니다.</p>
  ...
  <p>참고: <code>curveDetail()</code>은 2D모드에서는 효과가 없습니다.</p>
line: 772
isConstructor: false
itemtype: method
example:
