...
description: >
  ...
  동작하지만 기본 정점 셰이더가 포함되어 있습니다. <code>createFilterShader()</code> 함수는 캔버스의 내용을 필터링하기 위해 
  ...
  <p>매개변수인 <code>fragSrc</code>는 프래그먼트 셰이더를 설정합니다. 
  ...
  <p> <a href="/reference/p5/p5.Shader">p5.Shader</a> 객체에는 다음과 같은 유니폼이 설정됩니다:</p>
