...
description: >
  ...
  많은 픽셀이나 정점을 동시에 처리할 수 있어 많은 그래픽 작업에 빠릅니다. 
  
  이들은 <a href="https://developer.mozilla.org/en-US/docs/Games/Techniques/3D_on_the_web/GLSL_Shaders" target="_blank">GLSL</a>이라는 언어로 작성되며 스케치의 나머지 코드와 함께 실행됩니다.
  ...
  <li>조명이나 텍스처가 없는 경우.</li>

  <li><code>uStrokeWeight</code> 유니폼을 포함하는 경우 획을 그립니다.</li>

  </ul>

  <p> <a href="/reference/p5/p5.Shader">p5.Shader</a> 객체의 프래그먼트와 정점 셰이더의 소스 코드는 처음 <code>shader()</code>에 전달될 때 컴파일됩니다.
