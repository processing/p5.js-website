...
description: >
  <p>사용자 정의 도형에 이차 베지어 곡선 세그먼트를 추가합니다.</p>

  <p><code>quadraticVertex()</code> 함수는 사용자 정의 도형에 곡선 세그먼트를 추가합니다. 
  이 함수가 생성하는 베지어 곡선 세그먼트는
  ...
  <p>첫 번째 두 매개 변수인 , <code>cx</code> 와 <code>cy</code>
