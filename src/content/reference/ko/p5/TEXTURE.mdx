...
description: >
  ...
  <p>텍스처는 모양을 감싸는 피부와 같은 역할을 합니다. <code>texture()</code>는

  내장된 <a href="/reference/p5/square">square()</a>나 <a href="/reference/p5/sphere">sphere()</a>와 같은

  모양과 <a href="/reference/p5/buildGeometry">buildGeometry()</a>와 같은 함수로 생성된 사용자 정의 모양에서 작동합니다.

  <a href="/reference/p5/beginShape">beginShape()</a>로 생성된 기하학을 텍스처링하려면
