...
description: >
  ...
  href="/reference/p5/endGeometry">endGeometry()</a> 는 스케치를 더 효율적으로 만드는 데 도움이 됩니다. 
  예를 들어, 스케치가 실행되는 동안 복잡한 3D 도형이 변경되지 않는 경우, 

  <code>beginGeometry()</code> 와 <a href="/reference/p5/endGeometry">endGeometry()</a> 를 사용하여 만들 수 있습니다. 
