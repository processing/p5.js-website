...
description: |
  <p>El componente y del vector "arriba" de la cámara.</p>
  <p>El vector "arriba" orienta el eje y. Por defecto, el vector "arriba" es
  <code>(0, 1, 0)</code>, por lo que su componente es 1 en el espacio "local".</p>
line: 1636
isConstructor: false
itemtype: property
example:
