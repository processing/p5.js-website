...
description: >
  <p>Establece la posición de la cámara en el espacio "mundo" sin cambiar su

  orientación.</p>

  <p>Los parámetros <code>x</code>, <code>y</code> y <code>z</code> son las
  coordenadas donde la cámara

  debería estar ubicada. Por ejemplo, llamar a <code>myCamera.setPosition(10,
  20, 30)</code>

  coloca la cámara en las coordenadas <code>(10, 20, 30)</code> en el espacio
  "mundo".</p>
line: 3020
isConstructor: false
itemtype: method
...
params:
  - name: x
    description: |
      <p>coordenada x en el espacio "mundo".</p>
    type: Number
  - name: 'y'
    description: |
      <p>coordenada y en el espacio "mundo".</p>
    type: Number
  - name: z
    description: |
      <p>coordenada z en el espacio "mundo".</p>
    type: Number
chainable: false
---
