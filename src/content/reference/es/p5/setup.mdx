...
description: >
  ...
  <b>configurar el entorno inicial</b>, como el tamaño de la pantalla, el color del fondo, 
  y para cargar archivos multimedia, imágenes y fuentes, al inicializar el programa.
 <p>Solo puede haber una función <a href="/reference/p5/setup">setup()</a> por
