...
description: >
  ...
  <p>दो अपवाद हैं: <a href='/reference/p5/createCanvas'>createCanvas()</a> द्वारा बनाए गए कैनवास तत्व और <a href='/reference/p5/createGraphics">createGraphics()</a>
  द्वारा निर्मित <a href='/reference/p5/p5.Renderer'>p5.Render</a> ऑब्जेक्ट|</p>
line: 255
isConstructor: false
itemtype: तरीका
example:
