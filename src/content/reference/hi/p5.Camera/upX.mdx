...
description: |
  <p>कैमरे के "ऊपर" वेक्टर का एक्स-निर्देशांक।</p>
  
  <p>कैमरे का "ऊपर" वेक्टर इसके y-अक्ष को उन्मुख करता है। डिफ़ॉल्ट रूप से, "अप" वेक्टर <code>(0, 1, 0)</code> है, इसलिए इसका x-निर्देशांक "स्थानीय" स्थान में 0 है।</p>
line: 1525
isConstructor: false
itemtype: property
example:
