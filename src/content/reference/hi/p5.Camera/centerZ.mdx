...
description: >
  <p>उस स्थान का y-निर्देशांक जहां कैमरा दिखता है।</p>

  <p>डिफ़ॉल्ट रूप से, कैमरा "विश्व" स्थान में मूल <code>(0, 0, 0)</code> को देखता है, इसलिए <code>myCamera.centerZ</code> 0 है।</p>
line: 1412
isConstructor: false
itemtype: property
example:
