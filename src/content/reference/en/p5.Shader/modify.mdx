...
description: >-
  ...
  type of the data, such as <code>uniformFloat</code> for a number or
  ...
  <p>Move the mouse over this sketch to increase the moveCounter which will be
  passed to the shader as a uniform.</p>
