...
description: >
  ...
  href="/reference/./P2D"><code>P2D</code></a> renderer in the following
  ways:</p>
  ...
  3-dimensional shapes like <a href="/reference/./box">box()</a>, <a
  href="/reference/./sphere">sphere()</a>, <a
  href="/reference/./cone">cone()</a>, and <a
  ...
  href="/reference/./ambientLight">ambientLight()</a> to place around a scene.
  Materials like <a href="/reference/./specularMaterial">specularMaterial()</a>
  reflect the lighting to convey shape and depth. See <a
  ...
  files to be preloaded using <a href="/reference/./loadFont">loadFont()</a>.
  See <a
