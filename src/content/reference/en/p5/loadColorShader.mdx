...
description: >
  ...
  href="/reference/p5/buildColorShader/"><code>buildColorShader</code></a>,

  the version of <code>loadColorShader</code> that takes in a function instead
  of a separate file,
  ...
  <code>loadColorShader('myShader.js', onLoaded)</code>, then the
