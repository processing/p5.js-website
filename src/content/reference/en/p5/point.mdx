...
description: >
  ...
  <a href="./stroke">stroke()</a> function. To change its width, use the

  <a href="./strokeWeight">strokeWeight()</a> function. A point

  can't be filled, so the <a href="./fill">fill()</a> function won't
  ...
  <a href="./createCanvas">createCanvas()</a>.</p>

  <p>The version of <code>point()</code> with one parameter allows the point's
  location to

  be set with a <a href="./p5.Vector">p5.Vector</a> object.</p>
line: 731
isConstructor: false
itemtype: method
example:
