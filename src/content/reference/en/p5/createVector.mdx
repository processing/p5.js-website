...
description: >
  <p>Creates a new <a href="/reference/p5.Vector">p5.Vector</a> object.</p>
  ...
  <a href="/reference/p5.Vector">p5.Vector</a> object with an x-component of 3
  and a
  ...
  <p><a href="/reference/p5.Vector">p5.Vector</a> objects are often used to
  program
  ...
  <a href="/reference/p5.Vector">p5.Vector</a> class.</p>
line: 10
isConstructor: false
itemtype: method
example:
