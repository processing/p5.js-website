...
description: >
  ...
  <p>Calling <code>createVector()</code> with no arguments is deprecated and
  will emit

  a friendly warning. Use <code>createVector(0)</code>, <code>createVector(0,
  0)</code>, or
...
overloads:
  - params:
      - name: x
        description: List of numbers representing each component of the vector.
        type: Number
        rest: true
    return:
      description: new <a href="#/p5.Vector">p5.Vector</a> object.
