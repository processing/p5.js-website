...
description: >
  ...
  controlled by the <a href="/reference/p5/shininess">shininess()</a>
  function.</p>

  <p>Like <a href="/reference/p5/ambientMaterial">ambientMaterial()</a>,

  the specularMaterial() color is the color the object will reflect

  under <a href="/reference/p5/ambientLight">ambientLight()</a>.
  ...
  <a href="/reference/p5/spotLight">spotLight()</a>),
