...
# https://github.com/processing/p5.js/blob/v1.11.11/src/core/shape/vertex.js#L129
title: beginShape
module: Shape
submodule: Vertex
...
description: >
  ...
  vertices to a custom shape and <a
  href="/reference/p5/endShape/">endShape()</a> stops
  ...
  <a href="/reference/p5/endShape/">endShape()</a>. It's also not possible to
  use

  other shapes, such as <a href="/reference/p5/ellipse/">ellipse()</a> or

  <a href="/reference/p5/rect/">rect()</a>, between <code>beginShape()</code>
  and
