...
description: >
  ...
  href="./scale">scale()</a> is called

  within <a href="./draw">draw()</a>, the transformation is reset when the loop
  begins again.</p>

  <p>Using this function with the z parameter is only available in WEBGL mode.

  This function can be further controlled with <a href="./push">push()</a> and
  <a href="./pop">pop()</a>.</p>
line: 377
isConstructor: false
itemtype: method
