...
description: >
  ...
  <code>color(0, 100, 50)</code> in HSL.

  Some additional color modes that p5.js supports are:</p>
  ...
  <pre><code>    <img src="/assets/hwb.png"/></code></pre><p><code>LAB</code>   
  - Also known as CIE Lab, this color mode defines colors with Lightness, Alpha,
  and Beta.
