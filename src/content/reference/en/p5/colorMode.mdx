...
description: >-
  ...
  <p><code>RGBP3</code> - High Dynamic Range RGB defined within the Display P3
  color space.

  Colors are expressed with an extended dynamic range. To render these colors

  accurately, you must use the P3 canvas.</p>
  ...
  <pre><code>     <img
  src="/assets/hwb.png"></img></code></pre><p><code>LAB</code>    - Also known
  as CIE Lab, this color mode defines colors with Lightness, Alpha, and Beta.
  ...
  When a color is specified with only one parameter (e.g.,
  <code>color(g)</code>), p5.js will interpret it
...
return:
  ...
  type: RGB|HSB|HSL|RGBP3|HWB|LAB|LCH|OKLAB|OKLCH
overloads:
  - params:
      - name: mode
        description: |-
