...
description: >
  ...
  <a href="/reference/p5/createCamera">createCamera()</a> function and
  controlled through
  ...
  can be set through the <a href="/reference/p5/setCamera">setCamera()</a>
  method.</p>
  ...
  and forward-backward. The <a href="/reference/p5.Camera/move">move()</a>
  method,

  for instance, moves the camera along its own axes, whereas the

  <a href="/reference/p5.Camera/setPosition">setPosition()</a>
