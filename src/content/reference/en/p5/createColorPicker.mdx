...
description: >
  ...
  <a href="/reference/p5.Color">p5.Color</a> object is passed, it will set the
  default

  color.</p>

  <p>Color pickers extend the <a href="/reference/p5.Element">p5.Element</a>
  class with a
  ...
  href="/reference/p5.Color">p5.Color</a> object.</li>
