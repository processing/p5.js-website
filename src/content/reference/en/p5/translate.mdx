...
description: >
  ...
  translate(70, 0). If <a href="/reference/p5/translate">translate()</a> is
  called within <a href="/reference/p5/draw">draw()</a>, the

  transformation is reset when the loop begins again. This function can be

  further controlled by using <a href="/reference/p5/push">push()</a> and <a
