...
# https://github.com/processing/p5.js/blob/v1.11.11/src/core/shape/2d_primitives.js#L102
title: arc
module: Shape
...
description: >
  ...
  angles between which to draw the arc. By default, angles are given in radians,
  but if angleMode
