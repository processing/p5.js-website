...
description: >
  <p>The <a href="/reference/p5/keyIsDown">keyIsDown()</a> function checks if
  the key is currently down, i.e. pressed.
  ...
  the key, or use any of the variable <a
  href="/reference/p5/keyCode">keyCode</a> names listed
