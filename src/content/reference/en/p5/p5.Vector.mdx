...
description: >
  ...
  <p>Note: <a href="./createVector">createVector()</a> is the recommended way
...
methods:
  ...
  set:
    description: >
      ...
      <a href="#/p5.Vector">p5.Vector</a> object, as in <code>v.set(v2)</code>,
      or an
  ...
  sub:
    description: >
      ...
      <a href="#/p5.Vector">p5.Vector</a> object, as in <code>v.sub(v2)</code>,
      or an array
  ...
  mult:
    description: >
      ...
      <a href="#/p5.Vector">p5.Vector</a> object, as in <code>v.mult(v2)</code>,
      or an array
  ...
  div:
    description: >
      ...
      <a href="#/p5.Vector">p5.Vector</a> object, as in <code>v.div(v2)</code>,
      or an array
  ...
  mag:
    description: >
      ...
      <p>Use <a href="#/p5/mag">mag()</a> to calculate the magnitude of a 2D
      vector
