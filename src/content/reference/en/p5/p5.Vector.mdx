...
methods:
  ...
  copy:
    description: >
      <p>Returns a copy of the <a href="/reference/p5.Vector">p5.Vector</a>
      object.</p>
    path: p5.Vector/copy
  add:
    description: >
      ...
      another <a href="/reference/p5.Vector">p5.Vector</a> object, as in
  ...
  rem:
    description: >
      ...
      new <a href="/reference/p5.Vector">p5.Vector</a> object and doesn't change
      the
  ...
  dot:
    description: >
      ...
      <a href="/reference/p5.Vector">p5.Vector</a> object.</p>
  ...
  normalize:
    description: >
      <p>Scales the components of a <a href="/reference/p5.Vector">p5.Vector</a>
      object so
      ...
      returns a new <a href="/reference/p5.Vector">p5.Vector</a> object and
      doesn't change
  ...
  setMag:
    description: >
      ...
      a new <a href="/reference/p5.Vector">p5.Vector</a> object and doesn't
      change the
  ...
  equals:
    description: >
      ...
      interprets both parameters as <a href="/reference/p5.Vector">p5.Vector</a>
      objects.</p>
