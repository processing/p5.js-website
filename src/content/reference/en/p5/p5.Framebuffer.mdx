...
properties:
  pixels:
    description: >
      ...
      <p>Like the <a href="/reference/p5/pixels">main canvas pixels
      property</a>, call

      <a href="/reference/p5.Framebuffer/loadPixels">loadPixels()</a> before
      reading

      it, and call <a
      href="/reference/p5/p5.Framebuffer.updatePixels">updatePixels()</a>

      afterwards to update its data.</p>

      <p>Note that updating pixels via this property will be slower than

      <a href="/reference/p5.Framebuffer/begin">drawing to the framebuffer
      directly.</a>
  ...
  color:
    description: >
      ...
      framebuffer itself) to <a href="/reference/p5/texture">texture()</a> to
      draw it to
  ...
  depth:
    description: >
      ...
      be undefined. Pass this to <a href="/reference/p5/texture">texture()</a>
      to draw it to
