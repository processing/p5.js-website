...
# https://github.com/processing/p5.js/blob/v1.11.11/src/accessibility/outputs.js#L10
title: textOutput
module: Environment
...
description: >
  ...
  <a href="/reference/p5/gridOutput/">gridOutput()</a>, which uses its table as
  a grid.</p>
  ...
  <p><code>textOutput()</code> generates descriptions in English only. Text
  drawn with
