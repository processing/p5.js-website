...
description: >
  ...
  after calling <code>stroke()</code> will be outlined with the color orange.
  The way
  ...
  <p>Calling <code>stroke()</code> without an argument returns the current
  stroke as a <a href="/reference/p5/p5.Color">p5.Color</a> object.</p>
line: 1612
isConstructor: false
itemtype: method
example:
