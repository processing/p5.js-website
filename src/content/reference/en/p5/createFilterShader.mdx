...
description: >
  ...
  <a href="/reference/p5/filter/">filter()</a> function using GLSL.</p>

  <p>Since this method requires you to write your shaders in GLSL, it is most
  suitable

  for advanced use cases. Consider using <a
