...
description: >
  ...
  <code>'p2d'</code>. This is the default for 2D
  sketches.</li><li><code>P2DHDR</code> whose value is <code>'p2d-hdr'</code>
  (used for HDR 2D sketches, if available).</li></ul><p>See <a
