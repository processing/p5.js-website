...
description: |
  ...
  <a href="./saturation">saturation()</a> is called.</p>
  ...
  <p>Note: <a href="./color">color()</a> is the recommended way to create an
...
methods:
  ...
  setRed:
    description: |
      ...
      <p>The range depends on the <a href="#/colorMode">colorMode()</a>. In the
