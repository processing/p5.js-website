...
description: >
  <p>Sets the way text is aligned when <a href="./text">text()</a> is
  called.</p>
  ...
  <a href="./text">text()</a> interprets x-coordinates. By default, the
  ...
  <a href="./text">text()</a> interprets y-coordinates. By default, the
