...
description: >
  ...
  <li><a href="/reference/p5.Image">p5.Image</a></li>

  <li><a href="/reference/p5.Element">p5.Element</a></li>

  <li><a href="/reference/p5.Texture">p5.Texture</a></li>

  <li><a href="/reference/p5.Framebuffer">p5.Framebuffer</a></li>

  <li><a href="/reference/p5.FramebufferTexture">p5.FramebufferTexture</a></li>
