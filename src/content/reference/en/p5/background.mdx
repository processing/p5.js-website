...
description: >
  ...
  within <a href="./draw">draw()</a> to clear the display window at the

  beginning of each frame. It can also be used inside

  <a href="./setup">setup()</a> to set the background on the first frame
  ...
  <a href="./colorMode">colorMode()</a>. By default, colors are specified
