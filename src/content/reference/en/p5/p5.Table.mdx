...
description: >
  <p><a href="/reference/p5.Table">Table</a> objects store data with multiple
...
methods:
  addRow:
    description: >
      ...
      data to a <a href="/reference/p5.Table">p5.Table</a> object. By default,
      ...
      <p>If a <a href="/reference/p5.TableRow">p5.TableRow</a> object is
  ...
  getRows:
    description: >
      ...
      href="/reference/p5.TableRow">p5.TableRow</a>s.</p>
  ...
  addColumn:
    description: >
      ...
      column to a <a href="/reference/p5.Table">Table</a> object.
