...
description: >
  ...
  be used between <a href="./beginShape">beginShape()</a> and <a
  href="./endShape">endShape()</a> and only when there

  is no MODE parameter specified to <a href="./beginShape">beginShape()</a>.
