...
description: >
  ...
  <p>Calling <code>imageMode()</code> without an argument returns the current
  image mode, either <code>CORNER</code>, <code>CORNERS</code>, or
  <code>CENTER</code>.</p>
line: 1408
isConstructor: false
itemtype: method
...
class: p5
return:
  description: the current image mode
