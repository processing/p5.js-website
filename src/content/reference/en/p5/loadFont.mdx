...
description: >
  ...
  <code>@font-face</code> declaration.</a> It can also be an object containing
  key-value pairs with

  properties that you would find in an <code>@font-face</code> block.</p>
...
overloads:
  - params:
      - name: path
        description: >-
          path of the font to be loaded, a CSS <code>@font-face</code> string,
          or an object with font face properties.
        type: String|Object
      - name: name
        description: >-
