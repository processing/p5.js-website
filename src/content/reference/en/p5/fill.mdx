...
description: >
  ...
  <p>The version of <code>fill()</code> with four parameters interprets them as
  <code>RGBA</code>, <code>HSBA</code>,

  or <code>HSLA</code> colors, depending on the current <a
  href="/reference/p5/colorMode/">colorMode()</a>. The last parameter

  sets the alpha (transparency) value.</p>

  <p>Calling <code>fill()</code> without an argument returns the current fill as
  a <a href="/reference/p5/p5.Color">p5.Color</a> object.</p>
line: 1290
isConstructor: false
itemtype: method
example:
