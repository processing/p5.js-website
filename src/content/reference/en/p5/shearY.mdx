...
description: >
  ...
  <a href="./shearY">shearY()</a> is called within the <a
  href="./draw">draw()</a>, the transformation is reset when

  the loop begins again.</p>

  <p>Technically, <a href="./shearY">shearY()</a> multiplies the current
  transformation matrix by a

  rotation matrix. This function can be further controlled by the

  <a href="./push">push()</a> and <a href="./pop">pop()</a> functions.</p>
line: 490
isConstructor: false
itemtype: method
