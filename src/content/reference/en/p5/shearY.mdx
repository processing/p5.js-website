...
description: >
  ...
  <a href="/reference/p5/shearY">shearY()</a> is called within the <a
  href="/reference/p5/draw">draw()</a>, the transformation is reset when

  the loop begins again.</p>

  <p>Technically, <a href="/reference/p5/shearY">shearY()</a> multiplies the
  current transformation matrix by a
