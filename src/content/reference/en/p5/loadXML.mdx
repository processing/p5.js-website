...
description: >
  ...
  line in your sketch is executed. Calling <a href="./loadXML">loadXML()</a>
  inside <a href="./preload">preload()</a>

  guarantees to complete the operation before <a href="./setup">setup()</a> and
  <a href="./draw">draw()</a> are called.</p>

  <p>Outside of <a href="./preload">preload()</a>, you may supply a callback
