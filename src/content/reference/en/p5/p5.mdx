...
description: |
  ...
  its sole argument and may optionally set <a href="./preload">preload()</a>,
  <a href="./setup">setup()</a>, and/or
  <a href="./draw">draw()</a> properties on it for running a sketch.</p>
