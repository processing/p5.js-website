...
file: src/dom/dom.js
description: >
  <p>Creates a <code><span/></code> element.</p>

  <p><code><span/></code> elements are commonly used as containers

  for inline elements. For example, a <code><span/></code>
  ...
  inner HTML of the new <code><span/></code>.</p>
line: 507
isConstructor: false
itemtype: method
example:
