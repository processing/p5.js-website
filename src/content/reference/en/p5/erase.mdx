...
description: >
  ...
  <a href="./fill">fill()</a>, <a href="./stroke">stroke()</a>, and

  <a href="./blendMode">blendMode()</a> have no effect once <code>erase()</code>
  is
  ...
  <p>To cancel the erasing effect, use the <a href="./noErase">noErase()</a>
  ...
  <a href="./background">background()</a> functions.</p>
line: 1591
isConstructor: false
itemtype: method
example:
