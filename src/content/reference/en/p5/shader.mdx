...
description: >-
  ...
  <ul><li>strokeShader(): Applies a shader to the stroke (outline) of shapes,
  allowing independent control over the stroke rendering using
  shaders.</li><li>imageShader(): Applies a shader to images or textures,
  controlling how the shader modifies their appearance during
  rendering.</li></ul></p>
