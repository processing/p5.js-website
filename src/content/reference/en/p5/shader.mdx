...
description: >-
  ...
  <a href="/reference/p5/buildColorShader/"><code>buildColorShader</code></a>,
  and

  <a href="/reference/p5/buildNormalShader/"><code>buildNormalShader</code></a>
  functions. You can also use

  <a href="/reference/p5/buildFilterShader/"><code>buildFilterShader</code></a>
  alongside

  <a href="/reference/p5/filter/"><code>filter</code></a>, and

  <a href="/reference/p5/buildStrokeShader/"><code>buildStrokeShader</code></a>
  alongside

  <a href="/reference/p5/stroke/"><code>stroke</code></a>.</p>
  ...
  function draw() {
    ...
    rectMode(CENTER);
    rect(0, 0, 50, 50);
  }</code></pre><p>For advanced usage, shaders can be written in a language
  called
  ...
  <a href="/reference/p5/p5.Shader">p5.Shader</a> objects can be created in this
  way using the
