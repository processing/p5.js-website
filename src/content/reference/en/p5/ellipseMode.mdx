...
description: >
  ...
  <p>Calling <code>ellipseMode()</code> without an argument returns the current
  ellipseMode, either <code>CENTER</code>, <code>RADIUS</code>,
  <code>CORNER</code>, or <code>CORNERS</code>.</p>
line: 84
isConstructor: false
itemtype: method
example:
...
class: p5
return:
  description: the current ellipseMode.
