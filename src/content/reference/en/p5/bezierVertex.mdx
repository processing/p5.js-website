...
description: >
  ...
  href="./beginShape">beginShape()</a>

  call, it must be prefaced with a call to <a href="./vertex">vertex()</a> to
  set the first anchor

  point. This function must be used between <a
  href="./beginShape">beginShape()</a> and <a href="./endShape">endShape()</a>

  and only when there is no MODE or POINTS parameter specified to

  <a href="./beginShape">beginShape()</a>.</p>
line: 297
isConstructor: false
itemtype: method
alt: >-
