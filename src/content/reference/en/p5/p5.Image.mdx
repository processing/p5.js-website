...
methods:
  ...
  updatePixels:
    description: >
      ...
      <a href="./pixels">img.pixels</a> array.</p>

      <p><code>img.updatePixels()</code> only needs to be called after changing
      values in

      the <a href="./pixels">img.pixels</a> array. Such changes can be

      made directly after calling

      <a href="./loadPixels">img.loadPixels()</a> or by calling

      <a href="./set">img.set()</a>.</p>
  ...
  get:
    description: >
      ...
      <a href="./pixels">img.pixels</a>. Use

      <a href="./pixels">img.pixels</a> to read many pixel values.</p>
      ...
      <p>Use <code>img.get()</code> instead of <a href="./p5/get">get()</a> to
      work directly
  ...
  set:
    description: >
      ...
      <a href="./pixels">img.pixels</a> to set many pixel values.</p>
      ...
      <p><a href="./updatePixels">img.updatePixels()</a> must be called
  ...
  mask:
    description: >
      ...
      <p><code>img.mask()</code> uses another <a href="#./p5.Image">p5.Image</a>
      object's
