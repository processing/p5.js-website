...
description: >
  ...
  <a href="/reference/p5/loadXML">loadXML()</a> to load external XML files and
  create XML objects.</p>
line: 9
isConstructor: true
example:
  - |-
...
methods:
  ...
  listChildren:
    description: >
      ...
      href="/reference/p5.XML/getName">getName()</a>
  ...
  getChildren:
    description: >
      ...
      href="/reference/p5/p5.XML">p5.XML</a> objects. When
  ...
  addChild:
    description: >
      ...
      reference to an existing <a href="/reference/p5/p5.XML">p5.XML</a> object.

      A reference to the newly created child is returned as an <a
      href="/reference/p5/p5.XML">p5.XML</a> object.</p>
