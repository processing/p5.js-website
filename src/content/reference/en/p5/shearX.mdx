...
description: >
  ...
  If <a href="./shearX">shearX()</a> is called within the <a
  href="./draw">draw()</a>,

  the transformation is reset when the loop begins again.</p>

  <p>Technically, <a href="./shearX">shearX()</a> multiplies the current

  transformation matrix by a rotation matrix. This function can be further

  controlled by the <a href="./push">push()</a> and <a href="./pop">pop()</a>
  functions.</p>
line: 451
isConstructor: false
itemtype: method
