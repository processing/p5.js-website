...
description: >
  ...
  <p>Calling <code>sub()</code> with no arguments, as in <code>v.sub()</code>,
  has no effect.</p>
  ...
  For example, subtracting <code>[1, 2]</code> from <code>[3, 5, 7]</code> will
  result in <code>[2, 3]</code>.</p>
