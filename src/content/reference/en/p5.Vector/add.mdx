...
description: >
  ...
  <p>You should add vectors only when they are the same size. When two vectors
  ...
  adding <code>[1, 2, 3]</code> and <code>[4, 5]</code> will result in <code>[5,
  7]</code>.</p>

  <p>Calling <code>add()</code> with no arguments, as in <code>v.add()</code>,
  has no effect.</p>
