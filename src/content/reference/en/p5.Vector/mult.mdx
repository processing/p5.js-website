...
description: >
  ...
  will be multiplied by 2. Calling <code>mult()</code> with no arguments, as in
  <code>v.mult()</code>, has
  ...
  For example, multiplying <code>[1, 2, 3]</code> by <code>[4, 5]</code> will
  result in <code>[4, 10]</code>.</p>
