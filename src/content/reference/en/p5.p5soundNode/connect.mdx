...
description: >-
  ...
  You can connect a node to multiple destinations simultaneously by calling this
  method multiple times on additional destination nodes.
line: 78
isConstructor: false
itemtype: method
example:
...
params:
  - name: destination
    description: The node you would like to connect to.
    type: Object
chainable: false
---
