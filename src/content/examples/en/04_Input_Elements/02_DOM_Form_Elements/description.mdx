...
such as <a href="/reference/p5/createInput/" target="_blank">createInput()</a>,
<a href="/reference/p5/createSelect/" target="_blank">createSelect()</a>,
and <a href="/reference/p5/createRadio/" target="_blank">createRadio()</a>, you can build different ways to take information submitted through
