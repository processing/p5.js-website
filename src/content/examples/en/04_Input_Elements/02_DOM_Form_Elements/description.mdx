...
remix:
  ...
  - attribution:
    ...
    code:
      - label: pre-2023 code
        URL: https://github.com/processing/p5.js-website-legacy/blob/main/src/data/examples/en/16_Dom/13_DOM_Form_Elements.js
  ...
  - description: Revised by
    ...
    code:
      - label: 2023 code
        URL: https://github.com/processing/p5.js-example/tree/main/examples/04_Input_Elements/02_DOM_Form_Elements
---
