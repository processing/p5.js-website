...
description: >-
  <p>Frequency Modulation is a powerful form of synthesis.
  ...
  <b>Modulation Depth</b> describes how much the carrier frequency will
  modulate.
  ...
  <p><b>Modulation Frequency</b> is the speed of modulation. When the modulation
  frequency is lower
  ...
  If the modulator waveform is symetrical like a square <code>[]</code>, sine
  <code>~</code>

  or triangle <code>/\</code>, the negative amplitude will be the same as
  positive amplitude.
