...
आप <a href='/reference/#/p5/loadFont' target='_blank'>loadFont()</a> और <a href=/"/reference/#/p5/fontSize/" target="_blank">fontSize()</a> फ़ंक्शन का उपयोग करके फ़ॉन्ट और टेक्स्ट का आकार बदल सकते हैं।
