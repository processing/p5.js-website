...
p5js was selected to receive a total of €450,000 through two rounds of funding from the [Sovereign Tech Fund](https://sovereigntechfund.de/en) to enhance [p5.js Documentation organization & accessibility](https://www.sovereigntechfund.de/tech/p5js). This work is part of the Sovereign Tech Fund’s [Contribute Back to Open Source Challenges](https://sovereigntechfund.de/en/challenges/).
