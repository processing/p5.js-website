...
![Web test](src/content/contributor-docs/images/unit-visual-test.png) | ![Terminal test](src/content/contributor-docs/images/unit-visual-test-terminal.png)
...
Running `npm test` launches Vitest’s interactive UI at [http://localhost:63315](http://localhost:63315), where you can view the list of all test cases including visual tests as well.
...
![Example](src/content/contributor-docs/images/pixelmatch2.png)
...
![Example](src/content/contributor-docs/images/pixelmatch.png)
