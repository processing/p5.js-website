...
description: >-
  Understand and use p5.js’ Web Accessibility features to make your sketch
  accessible.
---
...
![An orange circle and pink square on a light purple canvas](/images/contributor-docs/sketch-with-shapes.png)
...
![A p5.js canvas, with the text descriptions described earlier present below it](/images/contributor-docs/sketch-text-output.png)
...
![A p5.js canvas, with a description below reading, "A pink square with a red heart in the bottom-right corner."](/images/contributor-docs/sketch-text-output2.png)
...
![A p5.js canvas, followed by two lines of description: "A red heart and yellow circle over a pink background," and "Heart: A red heart in the bottom-right corner."](/images/contributor-docs/sketch-text-output3.png)
