...
description: How all the updates on GitHub get turned into a new version of the library.
---
...
![Screenshot of GitHub action running the "New p5.js release" job](/images/contributor-docs/release-action.png)
