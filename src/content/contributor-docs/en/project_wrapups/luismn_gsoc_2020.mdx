---
title: p5.js accessibility and canvas descriptions
description: 'GSoC 2020 | [Luis Morales-Navarro](https://luismn.com/)'
---
...
More information on how these accessibility features work is available in the [web accessibility contributor docs](https://github.com/processing/p5.js/blob/main/contributor_docs/web_accessibility/).
