---
title: p5 for 50+ teaching
description: >
  Reaching out to 50 and more p5 educators around the world, "p5 for 50+
  teaching" aims to contribute in documenting, showcasing, and sharing teaching
  experiences, specifically by re-using the existing features of p5js.org. The
  project was mentored by Qianqian Ye.
---
# p5 for 50+ teaching
...
* Final Pull Request: [https://github.com/processing/p5.js-website/pull/867](https://github.com/processing/p5.js-website/pull/867)

* Demo Videos: [https://drive.google.com/drive/folders/1FjKJWYg4SDX\_WUft2lvSEqNduB68t84o?usp=sharing](https://drive.google.com/drive/folders/1FjKJWYg4SDX_WUft2lvSEqNduB68t84o?usp=sharing)
