...
title: |
  Code Slang!
description: >
  During GSoC 2019, Sharon De La Cruz and Jenna Xu worked on developing Code
  Slang, a project where slang words are presented as functions as a way to make
  math and functional programming more accessible to high school-age students.
---
# Code Slang!
