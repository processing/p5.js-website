---
title: >-
  Designing a test strategy to maintain and update mobile usability of p5.js (by
  [@LadySith](https://github.com/LadySith))
description: >-
  The main goal of my project was to design a test strategy and extensively test
  and update the p5.js mobile functionality so that compatibility issues can be
  tracked easily with updates to the library and mobile platforms. A lot of the
  project involved performing my own visual tests on various devices both real
  and virtual.
---
