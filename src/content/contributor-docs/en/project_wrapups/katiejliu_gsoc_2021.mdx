---
title: Adding Alt Text to the p5.js Website (GSoC 2021)
description: >-
  For my Google Summer of Code project, I added alt text to the visual elements
  of the p5.js website, specfically to all of the examples. With the help of my
  mentors Rachel and Claire,  I was able to improve the accessibility of the
  p5.js website for users with visually impairment.
---
