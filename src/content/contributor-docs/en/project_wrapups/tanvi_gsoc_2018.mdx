---
title: Improvements to existing I/O Methods of p5.js
description: >-
  My project for GSoC'18 initially revolved around looking into the I/O methods
  and trying to resolve the existing issues related to them. It later moved into
  closing issues related to WebGL and many old I/O issues were resolved.
---
