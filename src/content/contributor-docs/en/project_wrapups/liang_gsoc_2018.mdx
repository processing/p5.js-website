---
title: New JavaScript console in p5.js web editor
description: >
  My project for GSoC 2018 was to integrate a new console to p5.js web editor.
  There are two main tasks that l focused.
---
