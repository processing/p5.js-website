...
* [https://v1.p5js.org/contribute/](https://v1.p5js.org/contribute/) (for p5.js v1)
* [https://p5js.org/contribute/](https://p5js.org/contribute/) (for p5.js v2)
...
5. Run `npm install`
6. Modify and run the following command, using the path to **your** local p5.js repo, and the name of **your** branch:
...
* Check that a corresponding `.mdx` file is being generated in `../en` in the website file-structure.  If not, check if your .md file is git in the branch you've specified, in the correct location, and check the logs, during the website build:contributor-docs
...
Keep the filename concise but do not use contractions.  e.g. "documentation\_style\_guide" not "doc\_style\_guide".  If in doubt check the names of the other documents in the folder and try to stay aligned with those.
