...
* Improve Friendly Error System documentation
  * Add comments to https://github.com/processing/p5.js/blob/main/src/core/friendly\_errors/fes\_core.js to better document what’s happening in this process.
