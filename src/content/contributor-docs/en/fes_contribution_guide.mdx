---
title: Friendly Errors System Contribution Guide
description: >
  An overview of the Friendly Error System codebase and a reference for
  developers.
---
...
![A diagram of the files used in FES and their uses](/images/contributor-docs/fes.svg)
