...
This document describes how to work with p5.js version 1.x, whose reference documentation is currently being hosted at [https://p5js.org/reference/](https://p5js.org/reference/).  If you are documenting code for p5.js **v2.x**, you should consult instead [this document at beta.p5js.org](https://beta.p5js.org/contribute/contributing_to_the_p5js_reference/) as some syntax and processes differ between the versions.
