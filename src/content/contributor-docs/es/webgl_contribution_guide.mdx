---
title: Guía de Contribución a WebGL
description: How to get started working on the p5.js WebGL mode source code.
---
...
* Lee nuestra [visión general de la arquitectura WebGL de p5.js](webgl_mode_architecture/) para entender cómo difiere el modo WebGL del modo 2D. Esta será una referencia valiosa para algunos detalles de implementación para shaders, trazos y más.
