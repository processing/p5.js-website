...
* 다음은 [p5.js 처음으로 설정](./README/)할 경우에 대한 안내입니다.
* 이 레퍼런스는 소스 코드의 인라인 설명서에서 작성됩니다('src/' 폴더에서 찾아 볼 수 있음).
* 다음은 [인라인 설명서 및 예제를 업데이트하거나 추가하는 방법](./inline_documentation/)에 대한 정보입니다.
...
* 현재 [프로세싱 예제 페이지](https://processing.org/examples/)에서 [p5.js 예제 페이지](http://p5js.org/examples)로 예제들을 포팅하는 작업을 진행하고 있습니다. 여러분이 이 작업에 도움을 주고 싶다면, [여기](https://github.com/processing/p5.js-website/blob/main/contributor_docs/Adding_examples/)의 안내를 참조하시기 바랍니다.
...
* 선택 사항: 레파지토리 개요를 확인하기 위해 [컨트리뷰터 문서](./README/)를 확인하고, 코드 작성 방법을 배웁니다(해당되는 경우).
