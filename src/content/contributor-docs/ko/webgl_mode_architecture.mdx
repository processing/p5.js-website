---
title: p5.js WEBGL 모드 아키텍쳐
description: >-
  이 문서는 p5.js 기여자, 메인테이너 및 기타 이해 관계자를 위한 p5.js의 WEBGL 모드의 구조를 설명합니다. 스케치에서 3D
  그래픽을 사용하는 데 관심이 있다면 대신에 [튜토리얼
  보기](https://github.com/processing/p5.js/wiki/Getting-started-with-WebGL-in-p5)를
  참조해주세요.
---
# p5.js WEBGL 모드 아키텍쳐
