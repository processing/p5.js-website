...
다양한 이유로 이슈가 오픈될 수 있지만 우리는 보통 p5.js 소스 코드에 대한 개발에 대한 논의를 위해 이슈를 사용합니다. 당신의 코드 디버그, 프로젝트 협업자 초대 그리고 관련없는 주제는 [포럼 (forum)](https://discourse.processing.org/) 이나 [디스코드 (Discord)](https://discord.gg/SHQ8dH25r9) 같은 플랫폼에서 상의되어야합니다.
