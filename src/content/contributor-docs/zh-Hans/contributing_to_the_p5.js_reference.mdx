---
title: 为 p5.js 参考文献做贡献
description: Write and edit p5.js reference using the right format.
---
...
![Screenshot of the p5.js reference page of the "red()" function, showing only the example code section.](/images/contributor-docs/reference-screenshot.png)
...
有关参考资料相关 issue 的示例，请查看[#6519](https://github.com/processing/p5.js/issues/6519) 和 [#6045](https://github.com/processing/p5.js/issues/6045)。[贡献者指南](https://github.com/processing/p5.js/blob/main/contributor_docs/contributor_guidelines/) 文档也是一个很好的起点。
